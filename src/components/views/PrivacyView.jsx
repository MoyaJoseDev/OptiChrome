...
// PrivacyView muestra información clara sobre la privacidad de la extensión.
  ...
  <>
    ...
    <div className="glass-card text-xs leading-relaxed text-text-dim">
      ...
      <ul className="pl-4 space-y-3 marker:text-border-neon">
        <li>
          <strong className="text-white">Cero Recopilación:</strong> No
          guardamos, rastreamos ni enviamos tu historial o actividad.
        </li>
        <li>
          <strong className="text-white">Procesamiento Local:</strong> Toda la
          magia ocurre exclusivamente en el procesador de tu computadora.
        </li>
        <li>
          <strong className="text-white">Permisos Estrictos:</strong> Solo
          accedemos a tus pestañas para poder pausarlas, nunca leemos su
          contenido.
        </li>
      </ul>
    </div>
