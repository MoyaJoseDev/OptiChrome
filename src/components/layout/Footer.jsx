export const Footer = () => (
  <div className="mt-6 pt-5 border-t border-white/5 text-center pb-1">
    ...
    <a href="https://github.com/TU_USUARIO" target="_blank" className="text-slate-300 font-black text-sm no-underline hover:text-white hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)] transition-all">José T. Moya</a>
