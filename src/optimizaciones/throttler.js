// optimizaciones/throttler.js - Optimización simple para pestañas en segundo plano.
// Este script pausa animaciones y videos cuando la pestaña no está visible.

(function () {
  console.log(
    "🟢 OptiChrome: Throttler inyectado correctamente en " +
  ...
  function checkVisibility() {
    console.log(
      "👁️ OptiChrome: Cambio de pestaña detectado. Estado:",
